# REQ-001 - Especificación de Requisitos de PacoCremas
...
| 1.1 | 16/09/2026 | Se agrega el número de teléfono al estudiante según CR-001 | BrandonBBlandon |
| 1.2 | 23/09/2026 | Se agrega el número de teléfono secundario al estudiante según CR-001 | BrandonBBlandon |

## 1. Propósito

PacoCremas es un sistema académico básico destinado a gestionar estudiantes, cursos y matrículas de una institución educativa.
